package org.itmo.servicelayer2.services.mapper;

import org.itmo.dataaccesslayer2.pojo.Master;
import org.itmo.servicelayer2.services.model.CreateShowCatResponse;
...
public class Mapper {
    ...
    public CreateShowUserResponse toCreateShowUserResponse(UserDetails user) {
        return CreateShowUserResponse.builder()
